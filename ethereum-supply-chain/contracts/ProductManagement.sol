...
contract ProductManagement {
    ...
    function buildProduct(string memory serial_number, string memory product_type, string memory creation_date, bytes32[1] memory part_array) public returns (bytes32){
    ...
    function getParts(bytes32 product_hash) public returns (bytes32[1] memory){
